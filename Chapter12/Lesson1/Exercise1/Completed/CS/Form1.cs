...
namespace DeclarativeRBS
{
    ...
    public class Form1 : System.Windows.Forms.Form
	{
		...
		public Form1()
		{
            ...
            if (!(currentIdentity.Name.ToLower() == System.Environment.MachineName.ToLower() + @"\cphilp"))
            {
        ...
        private void addButton_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                // Because this method is called by a Windows event, protect it with
                // a imperative RBS demand
        ...
        private void divideButton_Click(object sender, System.EventArgs e)
        {
            ...
            string allowUser = System.Environment.MachineName + @"\cphilp";
            try
            {
